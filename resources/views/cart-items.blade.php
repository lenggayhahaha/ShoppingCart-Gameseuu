...
<div class="container" style="margin-top: 230px !important; background-color: #333333; color: #fff">
...
@if($count_cart != 0)
    ...
    <div class="row">
        <div class="col-md-12" style="text-align: center;">
            ...
            <form>
                ...
                <input type="hidden" name="business" value="seveven88@gmail.com">
    ...
    <?php $x=1; ?>
    @foreach($carts as $cart)
        <section class="background mySlides" style="border: 5px solid #d9534f; width: 1050px; background-color: #333333; color: #fff !important;">
            <div class="row margin-top">
                ...
                <img src="/img/{{ $cart -> imagePath }}" width="100%" height="500px" class="col-md-6">
                <div class="col-md-6">
                    ...
                    <form action="/update-quantity/{{ Auth::user()->id }}/{{ Auth::user()->name }}" method="post" accept-charset="utf-8">
                    {{ csrf_field() }}
                        <div class="input-group col-md-7">
                            <span class="input-group-addon" style="font-family: Segoe UI Light"> Quantity </span>
    ...
    <div class="modal fade" id="confirmation{{$y}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" style="color: #000 !important; font-family: Segoe UI Light; text-align: center;">
                    Are you sure you want to remove this {{ $cart -> product_name }} to cart?
                </div>
                <div class="modal-footer">
                    <form action="/home/delete" method="post" accept-charset="utf-8">
                    {{ csrf_field() }}
                        <input type="hidden" name="product_id" value="{{ $cart -> product_id }}">
                        <input type="hidden" name="customer_id" value="{{ Auth::user()->id }}">
