...
<section class="bg-faded" style="background-color: #333333;">
    <div class="container" style="font-family: Segoe UI;">
        <div class="card card-container">

        <p style="text-align: center;"><i class="fa fa-pencil-square-o fa-3x" aria-hidden="true" ></i></p>

            <br><form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        {{ csrf_field() }}
